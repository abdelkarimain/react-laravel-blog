  ...
  return (
    <div>
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto ">
        <h1 className="text-3xl font-bold lg:text-6xl text-center md:text-start">
          {t("welcomeToBlog") || "Welcome to My Blog"}
        </h1>
      ...
      <div className="mx-auto w-full max-w-2xl px-6 lg:max-w-7xl my-10 mb-20">
        <div className="relative flex justify-center mb-5">
          {/* Categories */}
          <ul
            className="flex items-center gap-4 py-4 px-6 -mt-4 overflow-x-auto whitespace-nowrap scrollbar
          ...
          >
            <li>
              <a
               ...
               border-teal-500 ${
                 category === "all" ? "bg-white text-slate-950" : ""
               }`}
                onClick={() => {
            ...
            {top5categories.map((cat, index) => (
              <li key={index}>
                <a
                  className={`cursor-pointer inline-block border-2 rounded-xl p-4 text-sm font-medium border-teal-500 ${
                    category === cat.category ? "bg-white text-slate-950" : ""
                  }`}
                  onClick={() => {
                    localStorage.setItem("homeCurrentPage", 1);
                    setCurrentPage(1);
        ...
        <h2 className="text-2xl font-semibold text-center">{t("recentPosts")}</h2>
        ...
        <div className="flex justify-center mt-4">
          <Pagination
            ...
            showIcons
            nextLabel={t("nextPage") || "Next"}
            previousLabel={t("prevPage") || "Prev"}
          />
        </div>
