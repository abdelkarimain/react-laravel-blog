...
const FooterCompo = () => {
  return (
    <>
      <Footer container className='border border-t-8 border-teal-500 bg-slate-200 text-gray-700'>
        <div className='w-full flex justify-center max-w-7xl mx-auto'>
          <div className="container relative flex flex-col items-center max-w-xl">
            ...
            <form onSubmit={(e) => e.preventDefault()} target="_blank" className="mt-16 space-y-2">
              <label className="text-center text-lg font-medium text-gray-800 dark:text-gray-300 ">
                Subscribe for 20+ new web tutorials every week
              </label>

              <div className="relative flex items-center">
                <input type="email" placeholder="E-mail address"
                  className="py-3 pl-4 pr-12 text-sm dark:text-gray-100 transition
                         dark:bg-gray-700 bg-slate-300 border-0 rounded-lg
                ...
                <button className="absolute flex items-center p-2 justify-center w-8 h-8 text-white rounded-md shadow-lg right-2 shadow-primary-700/30  bg-gradient-to-b from-primary-500 to-primary-600">
              ...
              <p className="text-sm dark:text-gray-400 tex-gray-800">
                You can unsubscribe at any time. You'll also get -20% off my courses!
              </p>

              <div className='bg-white' style={{ position: 'absolute', left: '-5000px' }} >
              </div>
            </form>
            ...
            <ul className="flex flex-wrap items-center justify-center gap-4 mt-16">
              ...
              <li>
                <a className="inline-flex dark:text-gray-300 hover:bg-gray-300 items-center gap-2 px-4 py-2 font-medium transition rounded-xl dark:hover:bg-gray-900 p-2"
              ...
              <li>
                <a className="inline-flex dark:text-gray-300  hover:bg-gray-300 items-center gap-2 px-4 py-2 font-medium transition rounded-xl dark:hover:bg-gray-900 p-2" target='_blank' href="https://github.com/abdelkarimain0">
            ...
            <p className="mt-11 text-lg text-gray-600 dark:text-gray-400">© {new Date().getFullYear()} Ain web blog
              <span className="px-2">•</span>
              <Link to="/about" className="underline">About my blog</Link>
            </p>
          </div>
        </div>
      </Footer>
